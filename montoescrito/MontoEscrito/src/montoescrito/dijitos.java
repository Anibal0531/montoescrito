...
class dijitos {
	...
	void testdosdijitos() {
	    ...
	    String valoresperado="trece";
	    String valorobtenido= dosdijitos.Concatenado(13);
	    assertEquals(valoresperado,valorobtenido);
	}
	void testundijitos() {
		MontoEscrito undijitos = new MontoEscrito();
	    String valoresperado="tres";
	    String valorobtenido= undijitos.Concatenado(3);
	    assertEquals(valoresperado,valorobtenido);
	    System.out.println(valorobtenido);
	}
}
